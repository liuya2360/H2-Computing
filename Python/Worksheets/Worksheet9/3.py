...
class CDLLL(DLLL):
    def insertFront(self, data): 
        ...
        if self._first == None: 
            ...
            newNode.setPrev(self._first.getPrev())
            newNode.setNext(self._first)
            self._first.getPrev().setNext(newNode)
            self._first.setPrev(newNode)
            self._first = newNode
    ...
    def exist(self, data): 
        if self._first == None: 
            ...
            if current.getData() == data: 
                ...
                current = current.getNext()
                while current.getData() != data and current.getNext() is not self._first: 
                    current = current.getNext() 
                if current.getData() == data: 
                    return True 
                else: 
    ...
    def print(self):
        ...
        result += str(current.getData()) + "\n"
        current = current.getNext()
        while current is not self._first: 
            result += str(current.getData()) + "\n"
            current = current.getNext()
        print(result)